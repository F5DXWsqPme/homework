...
namespace HW_4_2_08_03_2020.Test
{
    public class UniqueListTest
    {
        ...
        [Test]
        public void ListShouldThrowExceptionInAddAlreadyExistItem()
        {
            this.list.AddElement(1, 0);
            this.list.AddElement(2, 1);

            Assert.Throws<ElementAlreadyExistExceprtion>(() => this.list.AddElement(1, 0));
        }

        [Test]
        public void ListShouldAddItemAfterDelete()
        {
            this.list.AddElement(1, 0);
            this.list.AddElement(2, 1);
            this.list.DeleteElement(0);
            ...
            Assert.AreEqual(1, this.list.GetElement(0));
        }
